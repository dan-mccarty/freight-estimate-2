...
const FreightEstimatePage = () => {
      ...
      if (details['deliverySuburb']) {
        ...
        axios.get(url).then((resp) => {
          ...
          if (resp.data === '') {
            ...
            let temp = resp.data.filter(
              (result) => result.name === suburb && result.postcode === postcode,
            )
  ...
  return (
    <Box mt={2} mb={8}>
      <Box mb={4} mt={2}>
        <Typography variant="h2">Freight Estimate</Typography>
      </Box>
      ...
      <Box
        component={Paper}
        p={2}
        sx={{ flexGrow: 1, width: '1000px', bgcolor: 'rgb(240,240,240)' }}
        my={4}
      >
                    ...
                    <TableRow sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                      ...
                      <TableCell padding="normal" align="right">
                        <Button
                          ...
                          size="small"
                          variant="contained"
                          color={details.requireResidential ? 'success' : 'inherit'}
                          onClick={() =>
                            modfiyDetail(
                              'requireResidential',
                              !details.requireResidential,
                            )
                          }
                        >
                    ...
                    <TableRow sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                      ...
                      <TableCell padding="normal" align="right">
                        <Button
                          ...
                          size="small"
                          variant="contained"
                          color={details.requireTailGate ? 'success' : 'inherit'}
                          onClick={() =>
                            modfiyDetail('requireTailGate', !details.requireTailGate)
                          }
                        >
                    ...
                    <TableRow sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                      ...
                      <TableCell padding="normal" align="right">
                        <Button
                          ...
                          size="small"
                          variant="contained"
                          color={details.requireSignature ? 'success' : 'inherit'}
                          onClick={() =>
                            modfiyDetail('requireSignature', !details.requireSignature)
                          }
                        >
                    ...
                    ? details.productLines.map((line, index) => (
                        ...
                        >
                          ...
                          <TableCell padding="normal" align="right">
                            {line.isDG ? (
                              <BatteryAlertIcon
                                sx={{ transform: 'scale(0.9)', marginTop: '0.25rem' }}
                              />
                            ) : null}
                          </TableCell>
                        </TableRow>
            ...
            >
              <Grid>
                <Button
                  variant="contained"
                  color="success"
                  onClick={handleAddConsignmentItem}
                >
